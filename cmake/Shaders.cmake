...
function(hyprwin_add_shaders target)
  ...
  set(_outline_src "${PROJECT_SOURCE_DIR}/src/overlay/outline/default.hlsl")
  set(_shader_api "${PROJECT_SOURCE_DIR}/src/overlay/outline/hyprwin_shader_api.hlsl")
  set(_outline_vs_header "${PROJECT_BINARY_DIR}/outline_vs.h")
  set(_outline_ps_header "${PROJECT_BINARY_DIR}/outline_ps.h")
  set(_thumbnail_src "${PROJECT_SOURCE_DIR}/src/overlay/thumbnail/thumbnail.hlsl")
  set(_thumbnail_vs_header "${PROJECT_BINARY_DIR}/thumbnail_vs.h")
  set(_thumbnail_ps_header "${PROJECT_BINARY_DIR}/thumbnail_ps.h")
